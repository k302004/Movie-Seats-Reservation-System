                        ...
                        <td class="px-6 py-4">
                            <div class="text-sm">
                                ...
                                @if($reservation->payment_status === 'paid')
                                    <span class="text-green-500 text-xs"><i class="fas fa-check-circle mr-1"></i> Paid</span>
                                @else
                                    <span class="text-yellow-500 text-xs"><i class="fas fa-clock mr-1"></i> Unpaid</span>
                                @endif
                            </div>
                        </td>
                        <td class="px-6 py-4">
