...
<<<<<<< HEAD
                <div class="flex items-center justify-between mb-6 pb-6 border-b border-gray-700">
                    ...
                    <div class="flex items-center gap-3">
                        @if($reservations->first()->payment_method === 'cashless')
                            <span class="bg-blue-600/20 text-blue-400 px-4 py-2 rounded-full text-sm font-semibold">
                                <i class="fas fa-credit-card mr-1"></i> Cashless
                            </span>
                        @else
                        ...
                        @endif
                        @if($reservations->first()->payment_status === 'paid')
                            <span class="bg-green-600/20 text-green-400 px-4 py-2 rounded-full text-sm font-semibold">
